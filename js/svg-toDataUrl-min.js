SVGElement.prototype.toDataURL = function(type, options) {
	...
	function exportImage(type) {
		...
		var svg_xml = XMLSerialize(_svg);
		var svg_sizeTxt = _svg.getAttribute("viewBox").replace("0 0 ", "").split(" ");
		var svg_size = { width: Number(svg_sizeTxt[0]), height: Number(svg_sizeTxt[1]) };
		svg_img.src = base64dataURLencode(svg_xml);

		svg_img.onload = function() {
			debug("exported image size: " + [svg_size.width, svg_size.height])
