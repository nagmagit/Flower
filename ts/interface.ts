...
var docTitleElement  = <HTMLInputElement>document.getElementById("docName");
var zoomLevelElement = <HTMLInputElement>document.getElementById("zoomLevel");
...
document.getElementById("snapshotPNGBtn").addEventListener("mousedown", function () {
    prepairedFile = viewport.saveImage(actual_ProjName + ".png", "png");
});
...
document.getElementById("snapshotSVGBtn").addEventListener("mousedown", function() {
    prepairedFile = viewport.saveImage(actual_ProjName + ".svg", "svg+xml");
});
